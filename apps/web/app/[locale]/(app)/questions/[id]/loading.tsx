...
export default function QuestionDetailLoading() {
  return (
    <main className="min-h-screen bg-void overflow-x-hidden pt-2">
      ...
      <div className="h-[100dvh] min-h-[560px] flex flex-col overflow-hidden">
        {/* Header bar — mirrors the actual IDE header */}
        <div className="flex items-center justify-between border-b border-border/60 bg-background px-3 py-3 sm:px-6 sm:py-4 shrink-0">
          ...
          <div className="flex items-center gap-2">
            <Skeleton className="h-9 w-9 rounded-md sm:w-16" />
            <Skeleton className="h-9 w-9 rounded-md sm:w-16" />
          </div>
        </div>

        {/* Mobile tab strip */}
        <div className="flex border-b border-border/50 md:hidden shrink-0">
        ...
        <div className="flex-1 overflow-hidden p-4 space-y-4 md:hidden">
