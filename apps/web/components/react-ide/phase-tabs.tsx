      ...
      {PHASES.map(({ id, label, step }) => {
        ...
        return (
          <button
            ...
            disabled={isLocked}
            className={cn(
              'group relative flex items-center gap-1.5 rounded-md px-3 py-1.5 text-xs font-medium',
          ...
          >
            <span
              className={cn(
                'font-mono text-[9px] font-bold leading-none tabular-nums transition-colors duration-150',
